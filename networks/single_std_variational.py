...
class SingleStdVariationalBase(nn.Module):
    ...
    def build(
        ...
        self.means = means
        self.std = torch.nn.Parameter(torch.tensor(0.1), requires_grad=True,)
...
class SingleStdVariationalConvolution(SingleStdVariationalBase):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class SingleStdVariationalLinear(SingleStdVariationalBase):
    def __init__(
        self,
        in_features: int,
        out_features: int,
