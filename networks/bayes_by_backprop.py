...
class BayesByBackpropBase(nn.Module):
...
class BayesByBackpropConvolution(BayesByBackpropBase):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        **kwargs,
        ...
        droput = {
            "alpha": nn.AlphaBayesByBackprop,
            "standart": nn.BayesByBackprop,
            "feature_alpha": nn.FeatureAlphaBayesByBackprop
        }[dropout_type]
...
class BayesByBackpropLinear(BayesByBackpropBase):
    def __init__(
        self,
        in_features: int,
        out_features: int,
        ...
        **kwargs,
        ...
        nn.FeatureAlphaBayesByBackprop
...
class BayesByBackpropConvolutionTranspose(BayesByBackpropBase):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
