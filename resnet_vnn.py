...
from variational import VariationalConvolution, VariationalLinear
...
class ResNetVNN(Network):
    def __init__(
        ...
        self.conv1 = VariationalConvolution(
            3, 64, kernel_size=3,
            stride=1, padding=1, bias=False,
            use_batch_norm=True,
            **kwargs
...
def ResNetVNN18(num_classes=10, input_channels=3, **kwargs):
    return ResNetVNN(
...
def ResNetVNN34(num_classes=10, input_channels=3, **kwargs):
    return ResNetVNN(
...
def ResNetVNN50(num_classes=10, input_channels=3, **kwargs):
    return ResNetVNN(
...
def ResNetVNN101(num_classes=10, input_channels=3, **kwargs):
    return ResNetVNN(
...
def ResNetVNN152(num_classes=10, input_channels=3, **kwargs):
    return ResNetVNN(
